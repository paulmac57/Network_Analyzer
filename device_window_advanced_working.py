...
class AdvancedSetupWindow(object):
    ...
    def __init__(self, view, dev_pos,name,ip,login,password,com):
        ...
        self.view = view
        self.create_advanced_comms_window(dev_pos,name,ip,login,password,com)
    ...
    def create_advanced_comms_window(self,dev_position,name,ip,login,password,com):
...
# ,name,ip,login,password,com
    ...
    def on_save_button_clicked(self):
        ...
        self.parent.set_fields(position)
        self.setup_window.destroy()
