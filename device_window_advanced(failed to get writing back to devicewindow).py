...
class AdvancedSetupWindow(object):
    ...
    def __init__(self, master, parent, dev_pos,name,ip,login,password,com):
        ...
        self.master = master
        self.create_advanced_comms_window(master,dev_pos,name,ip,login,password,com)
        self.parent = parent
    ...
    def create_advanced_comms_window(self,master,dev_position,name,ip,login,password,com):
        ...
        device = self.master.controller.get_device_at(dev_position)
        if device:
            position = self.master.controller.get_numeric_notation(dev_position)
...
# ,name,ip,login,password,com
    ...
    def on_save_button_clicked(self):
        ...
        self.parent.set_fields(name,ip,login,password,com)
        self.setup_window.destroy()
